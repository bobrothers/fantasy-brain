...
export const TARGET_COMPETITION: Record<string, CompetitionInfo> = {
  ...
  'Nico Collins': { role: 'bellcow', competitors: ['Tank Dell', 'Stefon Diggs'], description: 'Alpha but crowded room', touchShare: 26 },
  'Tank Dell': { role: 'committee', competitors: ['Nico Collins', 'Stefon Diggs'], description: 'Explosive WR2/3', touchShare: 20 },
  'Stefon Diggs': { role: 'committee', competitors: ['Nico Collins', 'Tank Dell'], description: 'WR3 role', touchShare: 18 },
